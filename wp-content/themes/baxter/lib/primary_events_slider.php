...
class Primary_Events_Slider extends WP_Widget {
    public function __construct() {
        $widget_ops = array( 
			'classname' => 'baxter_primary_events_slider',
			'description' => 'Primary Events Slider',
		);
		parent::__construct( 'baxter_primary_events_slider', 'Primary Events Slider', $widget_ops );
    }
    ...
    public function widget( $args, $instance ) {
        ...
        ?>
        <section class="primary-events-slider">
        <?php
...
add_action( 'widgets_init', function(){
    register_widget( 'Primary_Events_Slider' );

    register_sidebar( array(
		'name'          => 'Primary Events Slider',
		'id'            => 'baxter_primary_events_slider',
		'before_widget' => '<div>',
		'after_widget'  => '</div>',
		'before_title'  => '<div>',
		'after_title'   => '</div>',
